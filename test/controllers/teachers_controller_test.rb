...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { admin_powers: @teacher.admin_powers, analysis_powers: @teacher.analysis_powers, color: @teacher.color, school_id: @teacher.school_id, teacher_description: @teacher.teacher_description, teacher_email: @teacher.teacher_email, teacher_icon_name: @teacher.teacher_icon_name, teacher_name: @teacher.teacher_name, user_name: @teacher.user_name } }
